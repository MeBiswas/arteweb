...
! function (e) {
    ...
    var r = {
        ...
        index: null,
        route: null,
        total: document.querySelectorAll(".q-preview-item").length,
        scrollArrowVisible: !1,
        portfolioVisible: !1,
        size: window.innerWidth,
        DOM: {
            objs: {},
            intro: document.querySelector("#q-intro"),
            mainWrapper: document.querySelector("#q-main-wrapper"),
            scrollRight: document.querySelector("#q-scroll-right")
        }
    };
    ...
    var r = n(0),
        ...
        s = function (e, t) {
            e && (t && e.classList.contains("q-no-point") && e.classList.remove("q-no-point"), t || e.classList.contains("q-no-point") || e.classList.add("q-no-point"))
        },
        u = function (e) {
        ...
        h = function (e) {
            var t = "q-".concat(e, "-view");
            ["q-home-view", "q-single-view", "q-page-view"].forEach(function (e) {
    ...
    ***************************************************************************** */
    ...
    var a = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.single = document.querySelector(".q-single"), this.DOM.move = this.DOM.sel.querySelector(".q-move"), this.DOM.col = this.DOM.sel.querySelector(".q-col"), this.DOM.titles = this.DOM.sel.querySelectorAll(".q-single-title"), this.delta = 0, this.offsetStart = (this.DOM.titles.length - 1) / this.DOM.titles.length * 100, this.offsetOffsetEnd = 1 / this.DOM.titles.length * 100, r.default.scrollbar && this.initEvents(), !r.default.scrollbar && this.initialAnimation()
        }
        var t, n, a;
        return t = e, (n = [{
            key: "reset",
    ...
    var s = function () {
        function e(t) {
            ...
            ! function (e, t) {
                ...
                a.DOM.wrapper.classList.add("q-shadows")
                ...
                sel: t
            }, this.DOM.mainList = document.querySelector("#q-main-list"), this.DOM.wrapper = this.DOM.sel.closest(".q-inner"), this.DOM.overlay = document.querySelector("#q-list-overlay"), this.DOM.themeInners = i(document.querySelectorAll(".q-theme:not(.q-active) .q-inner")), this.DOM.pseudoList = document.querySelector("#q-themes-pseudo"), this.DOM.pseudoCols = i(document.querySelectorAll("#q-themes-pseudo .q-col")), this.initEvents()
        }
        var t, n, s;
        return t = e, (n = [{
            key: "removeHover",
            value: function () {
                this.DOM.themeInners.forEach(function (e) {
                    e.parentElement.classList.remove("q-hover")
                })
            }
        }, {
            key: "setHover",
            value: function (e) {
                e.classList.add("q-hover"), r.default.DOM.objs.preview.changeImage(e.dataset.index)
            }
        }, {
            key: "changeImage",
            value: function () {
                var e = this,
                    t = function (t) {
                        document.querySelector(".q-hover") ? t.target.parentElement !== document.querySelector(".q-hover") && (e.removeHover(), e.setHover(t.target.parentElement)) : e.setHover(t.target.parentElement)
                    };
                this.DOM.themeInners.forEach(function (e) {
            ...
            value: function (e, t) {
                ...
                var a = e.closest(".q-theme");
                if (a.classList.add("q-active"), r.default.activeBg = "".concat(a.dataset.bg), r.default.activeColor = "".concat(a.dataset.color), this.DOM.overlay.style.backgroundColor = r.default.activeBg, TweenMax.set(document.body, {
                        ...
                        scaleX: 1,
                        ease: Expo.easeInOut
                    }), r.default.touch) this.DOM.mainList.classList.remove("q-blend"), TweenMax.to(".q-theme", .15, {
                    autoAlpha: 0,
                    overwrite: 1
                }), setTimeout(function () {
                    ...
                    var s = i(document.querySelectorAll(".q-theme:not(.q-active) .q-inner")),
                        u = a.getBoundingClientRect().left;
                    TweenMax.set(s, {
                        autoAlpha: 0,
                        overwrite: 1
                    }), TweenMax.to(a.querySelectorAll(".q-shadow"), .4, {
                        autoAlpha: 0,
                        delay: .6
                        ...
                        onStart: function () {
                            ...
                            }), n.DOM.mainList.classList.remove("q-blend")
                        },
                        onComplete: function () {
            ...
            value: function () {
                TweenMax.set(this.DOM.themeInners, {
                    autoAlpha: 1
                }), this.DOM.overlay.style.backgroundColor = r.default.activeBg, Object(o.togglePointer)(document.body, !0), this.DOM.mainList.classList.add("q-blend")
            }
        }, {
            key: "reset",
            value: function () {
                ...
                this.DOM.overlay.style.backgroundColor = r.default.activeBg, Object(o.togglePointer)(document.body, !0), TweenMax.set(this.DOM.sel.parentElement, {
                    ...
                    onComplete: function () {
                        e.DOM.mainList.classList.add("q-blend"), r.default.skin = null
                    }
                })
            }
        }, {
    ...
    var o = function () {
        ...
        return t = e, (n = [{
            ...
            value: function () {
                var e = this;
                this.cat = document.querySelector("#q-dieter-cat .q-extra");
                return {
                    cat: function () {
            ...
            key: "kenozoik",
            value: function () {
                this.double = document.querySelector("#q-kenozoik-double .q-reveal-holder"), this.quad = document.querySelector("#q-kenozoik-quad .q-reveal-holder");
                var e = function (e) {
                    for (var t = [], n = 0; n < e; n++) t.push('<div class="q-rect q-rect-'.concat(n + 1, '"><div class="q-rect-inner"></div></div>'));
                    return t.join("")
                };
                this.double.insertAdjacentHTML("beforeend", e(2)), this.quad.insertAdjacentHTML("beforeend", e(4));
                return {
                    double: function () {
                        var e = document.querySelectorAll("#q-kenozoik-double .q-rect-inner");
                    ...
                    quad: function () {
                        var e = document.querySelectorAll("#q-kenozoik-quad .q-rect-inner");
                        TweenMax.staggerTo(e, .1, {
                            autoAlpha: 1
                        }, .1), TweenMax.staggerFromTo(e, .5, {
                            x: "20%",
            ...
            value: function () {
                var e = this;
                this.wolf = document.querySelector("#q-haar-wolf .q-extra");
                return {
                    wolf: function () {
            ...
            value: function () {
                var e = this;
                this.first = document.querySelector("#q-penumbra-first .q-extra img"), this.firstBg = document.querySelector("#q-penumbra-first .q-bg-item"), this.second = document.querySelector("#q-penumbra-second .q-extra img");
                var t = function (e) {
                    TweenMax.to(e, .1, {
                        autoAlpha: 1,
                        delay: .2
            ...
            value: function () {
                var e = this;
                this.heroBg = document.querySelector("#q-amedeo-hero .q-bg-item");
                return {
                    hero: function () {
                        var t;
            ...
            value: function () {
                var e = this;
                this.sections = document.querySelectorAll("#q-smilte-crosses, #q-t-1, #q-simple-1, #q-s-2, #q-s-3, #q-s-4");
                return {
                    crosses: function () {
                        e.sections.forEach(function (e, t) {
                            e.insertAdjacentHTML("beforeend", '<div class="q-smilte-crosses-holder"></div>'), e.querySelector(".q-smilte-crosses-holder").insertAdjacentHTML("beforeend", function (e) {
                                for (var t = [], n = 0; n < e; n++) t.push('<span class="q-cross q-cross-'.concat(n + 1, '"><span></span><span></span></span>'));
                                return t.join("")
                            }(8)), 0 == t && TweenMax.staggerFromTo(e.querySelectorAll(".q-cross"), .35, {
                                autoAlpha: 0,
                                rotation: 20
                            }, {
                                autoAlpha: 1,
    ...
    var s = function () {
        function e(t) {
            ! function (e, t) {
                ...
                el: t
            }, this.DOM.burger = document.querySelector("#q-burger"), this.DOM.openLines = i(document.querySelectorAll(".q-menu-open line")), this.openLengths = this.DOM.openLines.map(function (e) {
                return Object(o.lineDistance)(e)
            }), this.DOM.closeLines = document.querySelectorAll(".q-menu-close line"), this.closeLength = Object(o.lineDistance)(document.querySelector(".q-menu-close line")), this.DOM.cover = document.querySelector("#q-cover"), this.DOM.navItems = i(document.querySelectorAll(".q-nav-item .q-masked")), this.DOM.navBtmItems = i(document.querySelectorAll(".q-nav-col-btm .q-masked")), this.DOM.navTextItems = i(document.querySelectorAll(".q-nav-col-btm .q-text")), this.DOM.inputLine = document.querySelector(".q-nav-col-btm .q-line"), this.DOM.inputArrow = document.querySelector(".q-newsletter svg"), this.initEvents()
        }
        var t, n, s;
        return t = e, (n = [{
            key: "toX",
            ...
            key: "homeTransition",
            value: function (e) {
                var t = document.querySelector("#q-themes"),
                    n = document.querySelectorAll(".q-list-wrapper");
            ...
            value: function (e) {
                ...
                this.cover(!0, function () {
                    r.default.navVisible = !0, t.toX(), t.showNavContent(e), !r.default.touch && r.default.DOM.objs.preview.fadeOutImage(0, 0), !r.default.touch && r.default.DOM.objs.list && r.default.DOM.objs.list.removeHover(), r.default.touch && (Object(o.togglePointer)(r.default.DOM.main, !1), document.querySelector("#q-navigation > .q-inner").scrollTo(0, 0))
                }, function () {
            ...
            key: "resize",
            value: function (e) {
                TweenMax.set(".q-header-item", {
                    autoAlpha: 0
                }), TweenMax.to(".q-header-item", .45, {
                    autoAlpha: 1,
                    ease: Power2.easeOut,
                    delay: .65
                })
            ...
            value: function () {
                ...
                this.DOM.burger.addEventListener("click", function () {
                    ...
                    Object.values(t.detail).find(function (e) {
                        return "home" === e
                    }) && (document.documentElement.classList.add("q-view-change"), !r.default.touch && e.resize(t))
                })
            }
        }]) && a(t.prototype, n), s && a(t, s), e
    }();
    ...
    var s = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.active = null, this.DOM.items = i(this.DOM.sel.querySelectorAll(".q-preview-item"))
        }
        var t, n, r;
        return t = e, (n = [{
            key: "changeImage",
            ...
            value: function () {
                new o.a({
                    ...
                    elements_selector: ".q-preview-image",
                    class_loaded: "q-loaded"
                })
            }
    ...
    var o = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.items = this.DOM.sel.querySelectorAll(".q-loader-item")
        }
        var t, n, o;
        return t = e, (n = [{
            key: "show",
            ...
            value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    t = this.DOM.sel.querySelector("#q-loader-counter");
                TweenMax.staggerFromTo(this.DOM.items, 1, {
                    y: "0%"
                }, {
                    y: "100%",
            ...
            key: "count",
            value: function () {
                var e = this.DOM.sel.querySelector("#q-loader-counter"),
                    t = {
                        val: 0
                    };
                TweenMax.to(t, 1.2, {
    ...
    var m = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t,
                Fx: {}
            }, this.DOM.mainScroll = document.querySelector("#q-main-scroll"), this.DOM.sections = this.DOM.sel.querySelectorAll("#q-title-col, .q-scroll-section:not(#q-next)"), this.DOM.sectionInners = this.DOM.sel.querySelectorAll(".q-scroll-section:not(#q-next) > .q-inner"), this.DOM.currentBg = document.querySelector(".q-bg-current"), this.DOM.nextBg = document.querySelector(".q-bg-next"), this.DOM.borderLine = this.DOM.sel.querySelector(".q-border-line"), this.DOM.next = this.DOM.sel.querySelector("#q-next"), this.DOM.nextInner = this.DOM.next.querySelector(".q-inner"), this.DOM.nextAreaBg = this.DOM.next.querySelector("#q-next .q-bg"), this.DOM.nextInner = this.DOM.next.querySelector("#q-next .q-inner"), this.DOM.nextTitle = this.DOM.next.querySelector(".q-next-title"), this.DOM.nextTagline = this.DOM.next.querySelector(".q-theme-tagline"), this.DOM.nextSVG = this.DOM.next.querySelector("svg"), this.DOM.links = this.DOM.sel.querySelectorAll(".q-fixed-link"), this.DOM.Fx.titleCol = {
                cons: s.default,
                sel: this.DOM.sel.querySelectorAll("#q-title-col")
            }, this.DOM.Fx.text = {
                cons: l.default,
                sel: this.DOM.sel.querySelectorAll(".q-text-fx")
            }, this.DOM.Fx.layered = {
                cons: h.default,
                sel: this.DOM.sel.querySelectorAll(".q-layered-fx")
            }, i.default.touch || (this.DOM.Fx.vertical = {
                cons: u.default,
                sel: this.DOM.sel.querySelectorAll(".q-vertical-fx")
            }, this.DOM.Fx.rail = {
                cons: c.default,
                sel: this.DOM.sel.querySelectorAll(".q-rail-fx")
            }, this.DOM.Fx.mobile = {
                cons: f.default,
                sel: this.DOM.sel.querySelectorAll(".q-mobile-fx")
        ...
        return t = e, (n = [{
            ...
            value: function (e) {
                ...
                this.DOM.borderLine && TweenMax.to(this.DOM.borderLine, .7, {
                    ...
                    ease: Power4.easeOut,
                    onStart: function () {
                        Object(a.togglePointer)(document.body, !1), i.default.DOM.objs.loader.show(.2), i.default.DOM.objs.loader.count(), "dark" == i.default.skin && t.DOM.next.classList.add("q-fade-out")
                    }
                    ...
                    ease: Expo.easeInOut,
                    onStart: function () {
                        t.DOM.next.classList.add("q-active"), t.DOM.nextTitle.style.color = t.DOM.next.dataset.color, TweenMax.set(document.body, {
            ...
            value: function (e) {
                var t = this;
                this.vTl = new TimelineMax, TweenMax.set(this.DOM.sel.querySelector(".q-visit-site"), {
                    autoAlpha: 0
            ...
            value: function () {
                var e = this,
                    t = new o.a({
                        ...
                        elements_selector: i.default.touch ? ".q-lazy:not(.q-media-video)" : ".q-lazy",
                        class_loaded: "q-loaded",
                ...
                void 0 !== window.safari && document.querySelectorAll(".q-lazy").forEach(function (e) {
                    t.load(e)
                })
            }
        }, {
            ...
            value: function () {
                var e = this;
                i.default.single = this.DOM.sel.getAttribute("id").split("q-").pop(), i.default.skin = this.DOM.sel.classList.contains("q-dark") ? "dark" : "light", i.default.touch || (this.setScrollArrow(), this.invokeSpecial(), this.arrowClick(), this.rAFSkew()), this.toggleLinks(), this.scrollFx(), this.setColors(), this.lazyLoad(), Object(a.togglePointer)(document.body, !0), this.DOM.sel.classList.add("q-loaded"), setTimeout(function () {
                    e.DOM.sel.classList.add("q-show-rail")
    ...
    var a = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.move = this.DOM.sel.querySelector(".q-move"), this.speed = this.DOM.move.getAttribute("data-speed") ? parseFloat(this.DOM.move.getAttribute("data-speed")) : 1, this.max = this.DOM.move.getAttribute("data-max") ? parseFloat(this.DOM.move.getAttribute("data-max")) : 100, this.DOM.media = this.DOM.sel.querySelector(".q-media.q-offset"), this.DOM.mediaOffset = this.DOM.media && this.DOM.media.getAttribute("data-offset"), this.buffer = 0, this.delta = 0, this.initEvents()
        }
        var t, n, a;
        return t = e, (n = [{
            key: "renderFx",
    ...
    var a = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.move = this.DOM.sel.querySelector(".q-move"), this.step = 25, this.delta = 0, this.initEvents()
        }
        var t, n, a;
        return t = e, (n = [{
            key: "listen",
    ...
    var a = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.move = this.DOM.sel.querySelector(".q-move"), this.step = 50, this.delta = 0, this.c = this.DOM.sel.classList.contains("q-top") ? -1 : 1, this.initEvents()
        }
        var t, n, a;
        return t = e, (n = [{
            key: "listen",
    ...
    var a = function () {
        function e(t) {
            ...
            ! function (e, t) {
                ...
                sel: t
            }, this.DOM.revealHolders = this.DOM.sel.querySelectorAll(".q-reveal-holder");
            var i = r.default.trigger && r.default.trigger.classList.contains("q-next-link");
        ...
        return t = e, (n = [{
            ...
            value: function (e) {
                TweenMax.to(e, .25, {
                    ...
                    ease: Power1.easeOut,
                    onComplete: function () {
                        var t = e.closest(".q-layout").getAttribute("id");
            ...
            value: function (e) {
                var t = e.classList;
                switch (!0) {
                    case t.contains("q-from-bottom"):
                        this.fromBottom(e);
                        break;
                    case t.contains("q-from-left"):
                        this.fromLeft(e);
                        break;
                    case t.contains("q-draw"):
                        this.draw(e);
                        break;
                    case t.contains("q-unmask"):
                        this.unMask(e)
                }
            }
        }, {
            ...
            value: function (e) {
                var t = this;
                r.default.scrollbar.isVisible(e) ? (this.animate(e.querySelector(".q-reveal")), cancelAnimationFrame(e.dataset.handle)) : requestAnimationFrame(function () {
            ...
            value: function (e) {
                var t = this;
                Object(o.isInView)(e) ? (this.animate(e.querySelector(".q-reveal")), cancelAnimationFrame(e.dataset.handle)) : requestAnimationFrame(function () {
                    return t.observe(e)
                })
            }
        }, {
    ...
    var u = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t,
                Fx: {}
            }, this.DOM.mainScroll = this.DOM.sel.querySelector("#q-main-scroll"), this.DOM.trigger = this.DOM.sel.querySelector("#q-trigger"), this.DOM.portfolio = this.DOM.sel.querySelector("#q-portfolio"), this.DOM.cover = this.DOM.sel.querySelector("#q-portfolio-cover"), this.DOM.ptfParts = this.DOM.sel.querySelectorAll(".q-portfolio-part"), this.DOM.close = this.DOM.sel.querySelector("#q-portfolio-close"), this.DOM.ptfScroll = this.DOM.sel.querySelector("#q-portfolio-scroll"), this.DOM.Fx.titleCol = {
                cons: a.default,
                sel: this.DOM.sel.querySelectorAll("#q-title-col")
        ...
        return t = e, (n = [{
            ...
            value: function () {
                var e = this,
                    t = new TimelineMax;
                r.default.portfolioVisible = !0, document.documentElement.classList.add("q-portfolio-open"), t.set(this.DOM.portfolio, {
                    display: "block"
                    ...
                    ease: Expo.easeInOut,
                    onComplete: function () {
                        e.DOM.portfolio.classList.add("q-show")
                    }
            ...
            value: function () {
                ...
                r.default.scrollbar && r.default.scrollbar.scrollTo(0, 0, 0), r.default.touch && window.scrollTo(0, 0), this.FX[0].reset(), t.fromTo(this.DOM.close, .3, {
                    ...
                    ease: Expo.easeInOut,
                    onComplete: function () {
                        r.default.portfolioVisible = !1, document.documentElement.classList.remove("q-portfolio-open"), e.DOM.portfolio.classList.remove("q-show"), e.DOM.scrollbar.scrollTo(0, 0, 0), TweenMax.set(e.DOM.portfolio, {
                            display: "none"
                        })
                    }
                }, "-=.65")
            ...
            value: function () {
                ...
                this.DOM.trigger.addEventListener("click", function () {
                    !e.DOM.portfolio.classList.contains("q-show") && e.showPortfolio()
                }), this.DOM.close.addEventListener("click", function () {
                    e.DOM.portfolio.classList.contains("q-show") && e.hidePortfolio()
                })
            }
        }, {
            key: "initScroll",
            value: function () {
                this.DOM.scrollbar = new i.default("#q-portfolio-scroll", "#q-portfolio-scroll")
            }
        }, {
            key: "initEvents",
            value: function () {
        ...
        return t = e, (n = [{
            ...
            value: function () {
                ...
                TweenMax.to(".four-oh-four", .25, {
                    ...
                    delay: .2,
                    onStart: function () {
                        e.DOM.sel.classList.add("q-ready")
                    }
                })
            }
        }, {
    ...
    var f = function () {
        function e(t) {
            ! function (e, t) {
                ...
                sel: t
            }, this.timelineDone = !1, this.val = this.delta = 0, this.total = r.default.touch ? 8 : document.querySelectorAll("#q-intro-slider .q-intro-slide").length, this.initEvents()
        }
        var t, n, o;
        return t = e, (n = [{
            key: "lazyLoad",
            value: function () {
                new i.a({
                    elements_selector: ".q-intro-lazy",
                    class_loaded: "q-loaded"
                })
            }
        }, {
            ...
            key: "skewList",
            value: function () {
                document.querySelector("#q-main-list > .q-inner").style.setProperty("--yVal", .25 * -this.val)
            }
        }, {
            key: "rAF",
            value: function (e) {
            ...
            key: "showScroll",
            value: function () {
                TweenMax.fromTo("#q-intro-scroll polyline", .65, {
            ...
            key: "hideScroll",
            value: function () {
                TweenMax.to("#q-intro-scroll polyline", .65, {
                    strokeDashoffset: 430,
                    x: -20,
                    overwrite: 1
                })
            ...
            key: "showSkip",
            value: function () {
                TweenMax.fromTo("#q-skip-the-line", .4, {
                    x: 10,
                    autoAlpha: 0
                }, {
                    x: 0,
            ...
            value: function () {
                ...
                document.querySelector("#q-skip-the-line").addEventListener("click", function () {
                    TweenMax.to(e.DOM.sel, .7, {
                        x: "-100%",
                        onStart: function () {
                            !r.default.touch && r.default.DOM.objs.preview.lazyLoad(), !r.default.touch && document.documentElement.classList.remove("q-with-intro"), r.default.DOM.objs.list.reset(!0, .25), TweenMax.to(e.DOM.sel.querySelectorAll("section"), .55, {
                                autoAlpha: 0,
                                onComplete: function () {
                                    !e.timelineDone && e.finishTimeline(), document.documentElement.classList.remove("q-with-intro")
                                }
                            })
                        },
                        ease: Power4.easeInOut
            ...
            value: function () {
                ...
                return t.to("#q-intro-title .q-1", 65, {
                    x: "-110vh"
                }).to("#q-intro-title .q-2", 65, {
                    x: "120vh"
                }, "-=65").to("#q-intro-title .q-3", 65, {
                    x: "-130vh"
                }, "-=65").to("#q-intro-title .q-4", 65, {
                    x: "140vh"
                }, "-=65"), t
            }
        }, {
            key: "showSlider",
            value: function () {
                TweenMax.fromTo("#q-intro-slider", 1, {
                    x: "100%",
                    autoAlpha: 1
                }, {
                    x: "0%",
                    delay: .1,
                    ease: Power4.easeOut
                }), TweenMax.fromTo("#q-intro-slider .q-inner", 1, {
                    x: "-80%"
                }, {
                    x: "0%",
                    delay: .1,
            ...
            key: "showSlide",
            value: function (e) {
                var t = document.querySelector(".q-intro-slide[data-index='".concat(e + 1, "']")),
                    n = document.querySelector(".q-intro-slide[data-index='".concat(e, "']"));
                !r.default.forwards && t && TweenMax.to(t, .2, {
                    autoAlpha: 0,
                    ease: Expo.easeOut
                }), r.default.touch && TweenMax.set(document.querySelectorAll(".q-intro-slide:not([data-index='".concat(e, "'])")), {
                    autoAlpha: 0
            ...
            value: function () {
                ...
                return n.to("#q-intro-slider", 100, {
                    x: -150 + this.viewportUnit()
                }), n
            }
        }, {
            key: "resetList",
            value: function () {
                TweenMax.set("#q-main-list .q-main", {
                    clearProps: "all",
                    overwrite: 1
                })
            }
                ...
                var e = this,
                    ...
                    n = new TimelineMax({
                        onUpdate: function () {
                            ...
                            !r.default.touch && e.moveList(o), !r.default.touch && e.rAF(), o >= .95 && !t && (t = !0, TweenMax.to(document.querySelector("#q-main-list > .q-inner"), .4, {
                                "--yVal": 0
                            }), TweenMax.to("#q-main-list .q-main", .3, {
                                y: "0%"
                            }), TweenMax.to("#q-header", .2, {
                                x: "0%",
                                y: "0%"
                            }), TweenMax.to("#q-intro-bg", .4, {
                                scaleX: "0",
                                overwrite: 1,
                                onComplete: function () {
                        ...
                        onStart: function () {
                            TweenMax.set(".q-theme > .q-inner", {
                                autoAlpha: 1
                            }), window.navigator.userAgent.indexOf("Edge") > -1 && TweenMax.set("#q-pt-1", {
                                autoAlpha: 0
            ...
            key: "finishTimeline",
            value: function () {
                this.timelineDone = !0, r.default.DOM.objs.list.set(), TweenMax.to(document.querySelector("#q-main-list > .q-inner"), .4, {
                    "--yVal": 0
                }), this.switchToList()
            }
        }, {
            key: "switchToList",
            value: function () {
                a.b.destroyAll(), this.DOM.sel.remove(), document.documentElement.classList.remove("q-with-intro"), !r.default.touch && this.checkForActive()
            }
        }, {
            key: "checkForActive",
            value: function () {
                if (!document.querySelector(".q-hover")) {
                    var e = document.querySelectorAll("#q-themes .q-theme"),
                        t = Math.floor(Math.random() * e.length);
                    !document.querySelector(".q-hover") && Object(u.fireEvent)("#q-themes .q-theme:nth-child(".concat(t, ") .q-inner"), "mouseenter")
                }
            }
        }, {
            key: "initTimeline",
                    ...
                    TweenMax.to(t, 1.2, {
                        ...
                        onStart: function () {
                            ! function (e) {
                                ...
                                sel: t.querySelector(".q-skew"),
                                prop: "skewX",
                                start: 40 * o,
                                duration: 1.32
                            }, {
                                sel: t.querySelector(".q-front"),
                                prop: "x",
                                start: 200 * o,
                                duration: 1.5
                            }, {
                                sel: t.querySelector(".q-back"),
                                prop: "x",
                                start: 50 * o,
                                duration: 1.5
                            }])
                        ...
                        onComplete: function () {
                            3 == n && (e.showSlider(), !r.default.touch && e.showScroll(), TweenMax.to(".q-mark", 1, {
                                autoAlpha: 1
                            }), e.initTimeline(), Object(u.togglePointer)(document.body, !0))
                        }
                    })
                };
                document.querySelectorAll("#q-intro-title .q-move").forEach(function (e, n) {
                    t(e, n)
                })
            }
        }, {
            key: "initEvents",
            value: function () {
                document.documentElement.classList.add("q-with-intro"), Object(u.togglePointer)(document.body, !1), r.default.scrollbar = new s.default("#q-scroll-vh", "#q-intro"), this.initialAnimation(), this.skipTheLine(), r.default.touch && this.DOM.sel.addEventListener("touchstart", function () {
                    Object(u.fireEvent)("#q-skip-the-line", "click")
                }, {
                    once: !0,
                    passive: !0
                })
    ...
    var r = n(0),
        ...
        v = n(62),
        m = function () {
            switch (r.default.touch && window.scrollTo(0, 0), delete r.default.DOM.objs.single, delete r.default.DOM.objs.page, !r.default.touch && r.default.DOM.objs.preview.lazyLoad(), r.default.DOM.objs.list = new f.default(document.querySelector("#q-themes")), r.default.initial || "dark" == r.default.skin) {
                case !0:
        ...
        y = function () {
            switch (r.default.navVisible && r.default.DOM.objs.nav.hideNav(), r.default.namespace) {
                case "home":
                    r.default.initial ? (r.default.DOM.objs.intro = new v.default(r.default.DOM.intro), r.default.DOM.objs.list = new f.default(document.querySelector("#q-themes"))) : m();
                    break;
                case "single":
                    r.default.touch && window.scrollTo(0, 0), r.default.touch || (r.default.scrollbar = new a.default("#q-main-scroll", "body")), r.default.DOM.intro && r.default.DOM.intro.remove(), delete r.default.DOM.objs.list, delete r.default.DOM.objs.page, r.default.DOM.objs.single = new h.default(document.querySelector(".q-single"));
                    break;
                case "page":
                    document.querySelector("#q-about") && (r.default.touch || (r.default.scrollbar = new a.default("#q-main-scroll", "body")), r.default.DOM.objs.page = new d.default(document.querySelector("#q-about")), document.documentElement.classList.add("q-page-loaded")), document.querySelector("#q-404") && (r.default.DOM.objs.page = new p.default(document.querySelector("#q-404")), document.documentElement.classList.add("q-page-loaded"))
            }
            r.default.initial = !1
        },
        g = function () {
            r.default.scrollbar && i.b.destroy(r.default.scrollbar), "page" == r.default.namespace && document.documentElement.classList.remove("q-page-loaded"), r.default.portfolioVisible = !1
        },
        b = function () {
            setTimeout(function () {
                y()
    ...
    window.addEventListener("DOMContentLoaded", function () {
        r.default.initial = !0, r.default.namespace = document.querySelector("main").getAttribute("data-barba-namespace"), Object(o.setRootClasses)(r.default.namespace), Object(s.default)(g, b).init(), window.addEventListener("resize", o.calcSize), r.default.DOM.objs.nav = new u.default(document.querySelector("#q-navigation")), r.default.DOM.objs.loader = new c.default(document.querySelector("#q-loader")), r.default.touch || (r.default.DOM.objs.preview = new l.default(document.querySelector("#q-preview"))), y()
